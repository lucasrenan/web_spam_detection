...
Como é possível analisar, o método que teve um resultado melhor foi o xxxxxx, tendo xxxxx\% de acurácia. O desempenho computacional dos métodos foram equivalentes, levando menos de um minuto para computar os resultados.
