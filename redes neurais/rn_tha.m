...
%[custo, grad] = JDeltha(theta_inicial, X, Y, tam_cam_entrada, tam_cam_inter,tam_cam_saida);

%custo = 0;
%grad =0;
%[custo, grad] = JDeltha(theta_inicial, X, Y, tam_cam_entrada, tam_cam_inter,tam_cam_saida);

%[custo, grad] = JDeltha(grad, X, Y, tam_cam_entrada, tam_cam_inter,tam_cam_saida);
...
[theta, custo] = ...
  fsolve(@(t)(JDeltha(t, X, Y, tam_cam_entrada, tam_cam_inter,tam_cam_saida)), theta_inicial, opcoes);
custo
%classificar
